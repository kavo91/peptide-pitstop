...
export function buildWearableUpsertArgs(
  ...
  const metrics: WearableMetrics = {
    ...
    // training (plaintext; absent → null-ish undefined leaves the column untouched on update)
    trainingReadiness: day.trainingReadiness,
    trainingReadinessLevel: day.trainingReadinessLevel,
    acuteLoad: day.acuteLoad,
    chronicLoad: day.chronicLoad,
    acwr: day.acwr,
    acwrStatus: day.acwrStatus,
    trainingStatus: day.trainingStatus,
    enduranceScore: day.enduranceScore,
    hillScore: day.hillScore,
    fitnessAge: day.fitnessAge,
    ltHr: day.ltHr,
    ltSpeedMs: day.ltSpeedMs,
    floorsClimbed: day.floorsClimbed,
    restingHr7d: day.restingHr7d,
