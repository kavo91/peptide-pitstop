 ...
 *
 * Telemetry stat tile — big mono value with a smaller muted unit, a sub-line,
 * a colour-coded delta line pinned to the bottom, and a 3px bottom accent bar.
 * The optional `delta` adds the bottom delta line and tints the accent bar.
 */
...
export function MetricTile({ label, value, sub, href, delta }: Props) {
